    ...
    <header class="header">
        ...
        <nav>
            <ul class="header__navbar">
                ...
                <li class="dropdown">
                    <a href="<?= base_link("admin/funcionarios") ?>" class="dropdown__btn <?= isUrl('admin/funcionarios') || isUrl('admin/funcionarios/cadastrar') || isUrl('admin/funcionarios/editar') ? 'header__link--active' : 'header__link' ?>">Funcionários</a>
